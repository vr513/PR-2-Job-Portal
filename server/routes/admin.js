...
const {findPendingVerificationRequests,getAllEmployers, blockUser , approveUser, getAllEmployersDetails} = require('../controllers/admin.controller');
...
router.get("/all-employers-details",verifyToken,adminCheck,getAllEmployersDetails);
